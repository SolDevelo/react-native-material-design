import React, { Component, PropTypes, View, Text, TouchableNativeFeedback, Image } from 'react-native';
            ...
            >
                {item.icon ?
                    <Icon
                        ...
                        color={color}
                        size={22}
                        style={(item.iconStyle) ? item.iconStyle : styles.icon}
                    />
                    : item.image &&
                    <Image
                        source={item.image}
                        style={(item.imageStyle) ? item.imageStyle : styles.icon}
                    />
                }
